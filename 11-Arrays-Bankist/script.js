...
let accountFor = {};
for (const acc of accounts) if (acc.owner === 'Jessica Davis') accountFor = acc;
...
1. Lakukan loop pada array yang berisi objek dogs, dan untuk setiap anjing, hitung porsi makanan yang direkomendasikan dan tambahkan ke objek sebagai properti baru. JANGAN membuat array baru, cukup lakukan pengulangan pada array tersebut. Forumla: recommendedFood = weight ** 0,75 * 28. (Hasilnya dalam gram makanan, dan beratnya harus dalam kg)
...
5. Masuk ke konsol apakah ada anjing yang memakan makanan dalam jumlah yang direkomendasikan (hanya benar atau salah)
...
6. Masuk ke konsol apakah ada anjing yang memakan makanan dalam jumlah yang BENAR (hanya benar atau salah)
*/
...
7. Buat array yang berisi anjing-anjing yang memakan makanan dalam jumlah yang BENAR (coba gunakan kembali kondisi yang digunakan pada nomor 6.)
*/
...
8. Buat salinan dangkal dari array dogs dan urutkan berdasarkan recommended food portion dalam urutan ascending (ingatlah bahwa porsinya ada di dalam objek array)
*/
